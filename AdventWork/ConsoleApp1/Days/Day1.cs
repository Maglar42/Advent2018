    ...
    public class Day1
    {
        ...
        public long Star2()
        {
            ...
            do
            {
                ...
                infLoopCounter++;
            } while (infLoopCounter < 10000);
            throw new Exception("No Dups found");
        }
        ...
        private bool Run()
        {
            ...
            {
                this.Value += i;
                if (this.FoundValues.Contains(this.Value))
                {
                    return true;
                }
                FoundValues.Add(this.Value);
                //Console.Write(value + ", ");
            }
            return false;
        }
